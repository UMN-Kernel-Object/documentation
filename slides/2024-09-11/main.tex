...
\begin{frame}{Advisor introductions}
	...
	\item Jack Kolb
		...
		\includegraphics[width=2em]{python.png}
...
\begin{frame}{Subgroups}
	...
	\item Next meeting, you can present to members and we'll poll everyone for what subgroup(s) they're interested in
	\end{itemize}
\end{frame}
...
\begin{frame}{Wrap-Up}
	...
	\item Propose your subgroup by \strong{next Wednesday}, September 18th
		\begin{itemize}
		\item We'll post a form in Discord
		\end{itemize}
	\item Next meeting is \strong{in two Wednesdays}, September 25th
	\end{itemize}
\end{frame}
